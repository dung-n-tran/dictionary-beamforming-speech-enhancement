...
dict_filename = "null_controlling_dl_interferences_{}_azimuth_step_{}_trainning_samples_{}.pkl".format(
    len(n_interference_list), azimuth_step, n_training_samples
)
...
with open(dict_filepath, 'wb') as output:
    pickle.dump(dlbeamformer, output, pickle.HIGHEST_PROTOCOL)
